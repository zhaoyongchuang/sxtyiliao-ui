  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <!--          <el-select v-model="queryParams.proName" placeholder="生产厂家" clearable size="small">-->
        <!--            <el-option-->
        <!--              v-for="dict in deptList"-->
        <!--              :key="dict.drugsProducer.proName"-->
        <!--              :label="dict.drugsProducer.proName"-->
        <!--              :value="dict.drugsProducer.proName"-->
        <!--            />-->
        <!--          </el-select>-->
        <!--        </el-form-item>-->
...
<script>
import {addDurgdurg, delDurgdurg, exportDurgdurg, getDurgdurg, listDurgdurg, updateDurgdurg} from "@/api/his/durgdurg";
