<template>
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="68px">
      ...
      <!--        <el-input-->
      <!--          v-model="queryParams.durgProducer"-->
      <!--          placeholder="请输入生产厂家"-->
      <!--          clearable-->
      <!--          size="small"-->
      <!--          @keyup.enter.native="handleQuery"-->
      ...
      <!--        <el-select v-model="queryParams.durgType" placeholder="请选择药品类型" clearable size="small">-->
    ...
    <el-table v-loading="loading" :data="durgdurgList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="生产厂家" prop="durgProducer"/>
