  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="68px">
      ...
      <el-form-item label="处方类型" prop="durgOtcType">
        <el-select v-model="queryParams.durgOtcType" clearable placeholder="处方类型">
          <el-option
      ...
      <el-form-item label="生产厂家" prop="queryParams.durgProducer">
        <el-select v-model="queryParams.durgProducer" clearable placeholder="生产厂家">
          <el-option
...
<script>
import {addDrug, delDrug, getDrug, listDrug} from "@/api/dis/drug";
import {parseTime} from "../../../utils/ruoyi";
import {listFactory} from '@/api/dis/factory.js'
